...
namespace SysToolbox.Core
{
    ...
    public static class StartupManager
    {
        ...
        public static List<StartupItem> Load()
        {
            ...
            ReadRegistryRun(list, RegistryHive.LocalMachine, RegistryView.Registry64, RunKey, StartupSource.RegistryRun, ApprovedRun);
            ReadRegistryRun(list, RegistryHive.LocalMachine, RegistryView.Registry32, Run32Key, StartupSource.RegistryRun, ApprovedRun32);
            ReadRegistryRun(list, RegistryHive.CurrentUser, RegistryView.Registry64, RunKey, StartupSource.RegistryRun, ApprovedRun);
            ReadRegistryRun(list, RegistryHive.CurrentUser, RegistryView.Registry64, RunOnceKey, StartupSource.RegistryRunOnce, ApprovedRunOnce);
            ReadRegistryRun(list, RegistryHive.CurrentUser, RegistryView.Registry32, RunOnce32Key, StartupSource.RegistryRunOnce, ApprovedRunOnce);

            ReadStartupFolder(list, Environment.SpecialFolder.Startup, "用户启动文件夹");
            ReadStartupFolder(list, Environment.SpecialFolder.CommonStartup, "公共启动文件夹");
